...
public class NhanVienBUS {
	 private NhanVienDAO nvDAO = new NhanVienDAO();
	    ...
	    public boolean themNhanVien(String ho, String ten, String gioiTinh, String cancuoc , int sdt , int luong) {
	        ho = ho.trim();
	        ten = ten.trim();
...
//	            new MyDialog("Thêm thành công!", MyDialog.SUCCESS_DIALOG);
	    ...
	    public boolean updateNhanVien(String ma, String ho, String ten, String gioiTinh, String cancuoc , int sdt , int luong) {
